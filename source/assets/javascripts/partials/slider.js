...
(function () {
    ...
    Swiper
    ===========================*/
    $hseLogoAnimate = $('.hse_logo_animate');
    window.Swiper = function (container, params) {
        ...
        s.updateClasses = function () {
            ...
            if (s.container.selector == '.swiper-1'){
                $hseLogoAnimate[0].className = $hseLogoAnimate[0].className.replace(/\bcolorLetter.*?\b/g, '');
                $hseLogoAnimate.addClass('colorLetter' + s.activeIndex);
            }
            // Active classes
